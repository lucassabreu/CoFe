<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/" mode="header">
        <div class="navbar navbar-fixed-top">
            ...
            <div class="go_to_top">
                <a href="#___" style="color: inherit">Back to top&#160;&#160;
    ...
    <xsl:template match="/" mode="content-footer">
        <footer class="span12">
            Template is built using 
            <a href="http://twitter.github.com/bootstrap/">Twitter Bootstrap 2</a> and icons provided by 
            <a href="http://glyphicons.com/">Glyphicons</a>.
            <br />
            Documentation is powered by 
            <a href="http://www.phpdoc.org/">phpDocumentor 
    ...
    <xsl:template match="/" mode="head">
        ...
        <![endif]-->
        <link href="{$root}stylesheets/pygment_trac.css" rel="stylesheet"/>
        <link href="{$root}css/template.css" rel="stylesheet" media="all" />    
        <link href="{$root}stylesheets/styles.css" rel="stylesheet" />
    ...
    <xsl:template match="/">
        ...
        <html lang="en">
            ...
            <body>
                ...
                <div id="___" class="container section">
                    <noscript>
    ...
    <xsl:template match="/" mode="report-overview">
        <li>
            <a href="{$root}markers.html">
                <i class="icon-map-marker icon-white"></i>&#160;Markers&#160;
                <ul>
        ...
        <li>
            <a href="{$root}deprecated.html">
                <i class="icon-stop icon-white"></i>&#160;Deprecated elements&#160;
