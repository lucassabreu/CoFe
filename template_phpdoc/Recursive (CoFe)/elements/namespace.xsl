<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="namespace" mode="sidebar">
        ...
        <li>
            ...
            >
                ...
                <a href="{$root}namespaces/{$link}.html" title="{@name}"><i class="icon-th icon-white"></i> <xsl:value-of select="@name" /></a>
            </xsl:if>
            ...
            <xsl:if test="count(/project/file/constant[@namespace=$fqnn]
                ...
                |/project/file/interface[@namespace=$fqnn]) = 0"
            >
                <span class="empty-namespace"><i class="icon-stop icon-white"></i> <xsl:value-of select="@name" /></span>
            </xsl:if>
    ...
    <xsl:template match="namespace" mode="contents">
        ...
        >
            <ul class="breadcrumb">
                <li>
                    <a href="{$root}index.html"><i class="icon-th icon-white"></i></a>
    ...
    <xsl:template match="namespace" mode="sidebar-nav">
        ...
        <ul class="side-nav nav nav-list">
            <li class="nav-header"><i class="icon-map-marker icon-white"></i> Namespaces</li>
