<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                        ...
                        <ul class="nav">
                            <li class="dropdown">
                                <a href="#api" class="dropdown-toggle" data-toggle="dropdown">
                                    Domentacao da API <b class="caret"></b>
                                </a>
    ...
    <xsl:template match="/" mode="head">
        ...
        <link href="{$root}stylesheets/template.css" rel="stylesheet" media="all" />
        ...
        <script src="{$root}js/respond.js" type="text/javascript"></script>
